    ...
    <section className="relative min-h-[calc(100vh-4.5rem)] flex items-center bg-gray-950 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 md:py-24 text-white w-full">
        <div className="max-w-2xl">
          {/* Top Tagline */}
          <span className="inline-block text-[#C9A253] font-manrope font-bold text-xs sm:text-sm tracking-widest uppercase mb-4">
            WELCOME TO YEKA MKC
          </span>

          {/* Main Title */}
          <h1 className="font-cinzel font-extrabold text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight text-white mb-6 tracking-tight">
            A Family of Faith, <br className="hidden sm:inline" />
            Hope &amp; Love
          </h1>

          {/* Subtitle */}
          <p className="font-manrope text-gray-200 text-base sm:text-lg md:text-xl font-normal leading-relaxed mb-8 max-w-xl">
          ...
          <div className="border-l-2 border-[#C9A253] pl-4 sm:pl-5 py-3 mb-10 my-6 max-w-xl bg-black/20 backdrop-blur-xs rounded-r-md">
